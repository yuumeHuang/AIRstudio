...
#define kDefaultCopilotPath        "bin/copilot-language-server-js"
...
#define SESSION_EXIT_TOO_MANY_OPEN_FILES      SESSION_EXIT_CODE_OFFSET + 6
#define SESSION_EXIT_NOT_ENOUGH_MEMORY        SESSION_EXIT_CODE_OFFSET + 7
